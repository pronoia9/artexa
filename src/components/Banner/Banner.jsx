    ...
    <div className='container-fluid'>
      <div className='row p-60-0 p-lg-30-0 p-md-15-0'>
        <div className='col-lg-12'>
          {/* background image */}
          <div className='art-a art-banner' style={{ backgroundImage: 'url(' + process.env.PUBLIC_URL + '/images/backgrounds/plexus.gif)' }}>
            ...
            <div className='art-banner-overlay'>
              ...
              {/* avatar */}
              <img src={process.env.PUBLIC_URL + props.data.avatar} className='art-banner-photo' alt='Banner Profile'></img>
            </div>
          </div>
        </div>
      </div>
