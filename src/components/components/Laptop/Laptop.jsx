...
export const Laptop = ({ hinge, ...props }) => {
  ...
  useFrame((state) => {
    ...
    state.camera.position.x = MathUtils.lerp(state.camera.position.x, laptopOpen ? 0 : 22.5, 0.075 * delay);
    state.camera.position.y = MathUtils.lerp(state.camera.position.y, laptopOpen ? 0 : 13, 0.05 * delay);
