...
export const Scene = (props) => {
  const { nodes, materials } = useGLTF('/src/components/components/Room/Assets/brunos-room-transformed.glb');
...
useGLTF.preload('/src/components/components/Room/Assets/brunos-room-transformed.glb');
