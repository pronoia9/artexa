    ...
    (function (e, t) {
      ...
      function at(e, t, n, i) {
        ...
        if (h && !i) {
          ...
          if (r.qsa && (!g || !g.test(e))) {
            if (
              ((m = d = b), (y = t), (x = 9 === l && e), 1 === l && 'object' !== t.nodeName.toLowerCase())
            ) {
              (c = mt(e)),
    ...
    var n,
      ...
      p = {
        ...
        fireWith: function (e, t) {
          return (
            !l || (i && !u) || ((t = t || []), (t = [e, t.slice ? t.slice() : t]), n ? u.push(t) : c(t)),
            this
          );
        },
        fire: function () {
          ...
          if (1 === u.nodeType && (u.disabled !== !0 || 'click' !== e.type)) {
            for (o = [], a = 0; l > a; a++)
              (i = n[a]),
                (r = i.selector + ' '),
                o[r] === t &&
                  (o[r] = i.needsContext ? x(r, this).index(u) >= 0 : x.find(r, this, null, [u]).length),
                o[r] && o.push(i);
          ...
          this.domManip(
            ...
            function (n) {
              var r = e[t++],
                i = e[t++];
              i &&
                (r && r.parentNode !== i && (r = this.nextSibling), x(this).remove(), i.insertBefore(n, r));
            },
            !0
          ),
          t ? this : this.remove()
    ...
    return (
      n ||
        ...
        ('none' !== n && n) ||
          ((Pt = (
            Pt ||
            x("<iframe frameborder='0' width='0' height='0'/>").css('cssText', 'display:block !important')
    ...
    Qn = {
      '*': [
        function (e, t) {
          ...
          return (
            i &&
              ((a = n.start = +a || +r || 0), (n.unit = o), (n.end = i[1] ? a + (i[1] + 1) * i[2] : +i[2])),
            n
          );
        },
      ],
        ...
        return (
          ...
          this.each(function () {
            var t,
              ...
              a = r ? r.length : 0;
            for (
              n.finish = !0, x.queue(this, e, []), i && i.stop && i.stop.call(this, !0), t = o.length;
              t--;
